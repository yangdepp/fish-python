...
def get_current_url(environ, root_only=False, strip_querystring=False,
    ...
    cat(url_quote(wsgi_get_bytes(get('SCRIPT_NAME', ''))).rstrip('/'))
    cat('/')
    if not root_only:
        cat(url_quote(wsgi_get_bytes(get('PATH_INFO', '')).lstrip(b'/')))
...
def get_content_length(environ):
    ...
    """
    if get('HTTP_TRANSFER_ENCODING', '') == 'chunked':
        return None
...
def get_query_string(environ):
    ...
    """
    qs = wsgi_get_bytes(get('QUERY_STRING', ''))
...
def get_path_info(environ, charset='utf-8', errors='replace'):
    ...
    """
    path = wsgi_get_bytes(get('PATH_INFO', ''))
...
def get_script_name(environ, charset='utf-8', errors='replace'):
    ...
    :param errors: the decoding error handling.
    """
    path = wsgi_get_bytes(get('SCRIPT_NAME', ''))
    return to_unicode(path, charset, errors, allow_none_charset=True)
...
def peek_path_info(environ, charset='utf-8', errors='replace'):
    ...
    """
    segments = get('PATH_INFO', '').lstrip('/').split('/', 1)
    if segments:
...
class DispatcherMiddleware(object):
    ...
    def __call__(self, environ, start_response):
        ...
        original_script_name = get('SCRIPT_NAME', '')
...
def wrap_file(environ, file, buffer_size=8192):
    ...
    """
    return get('wsgi.file_wrapper', FileWrapper)(file, buffer_size)

...
class WebSocketWSGI(object):
    ...
    def __call__(self, environ, start_response):
        if not (get('HTTP_CONNECTION').find('Upgrade') != -1 and
        ...
        key = get('HTTP_SEC_WEBSOCKET_KEY')
        if key:
            ...
            protocols = []
            subprotocols = get('HTTP_SEC_WEBSOCKET_PROTOCOL')
            ws_protocols = []
            if subprotocols:
            ...
            exts = []
            extensions = get('HTTP_SEC_WEBSOCKET_EXTENSIONS')
            ws_extensions = []
            if extensions:
...
class WebSocket(object):
    ...
    def __init__(self, sock, environ, version=76):
        self._socket = sock
        try:
            version = int(get('HTTP_SEC_WEBSOCKET_VERSION'))

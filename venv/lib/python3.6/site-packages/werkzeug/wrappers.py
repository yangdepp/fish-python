...
class BaseRequest(object):
    ...
    def args(self):
        ...
        """
        return url_decode(wsgi_get_bytes(get('QUERY_STRING', '')),
    ...
    def path(self):
        ...
        """
        raw_path = wsgi_decoding_dance(get('PATH_INFO') or '',
    ...
    def script_root(self):
        ...
        raw_path = wsgi_decoding_dance(get('SCRIPT_NAME') or '',
                                       self.charset, self.encoding_errors)
...
class AcceptMixin(object):
    ...
    def accept_mimetypes(self):
        ...
        """
        return parse_accept_header(get('HTTP_ACCEPT'), MIMEAccept)
    ...
    def accept_charsets(self):
        ...
        """
        return parse_accept_header(get('HTTP_ACCEPT_CHARSET'),
                                   CharsetAccept)
    ...
    def accept_encodings(self):
        ...
        :attr:`accept_charset`.
        """
        return parse_accept_header(get('HTTP_ACCEPT_ENCODING'))
    ...
    def accept_languages(self):
        ...
        """
        return parse_accept_header(get('HTTP_ACCEPT_LANGUAGE'),
                                   LanguageAccept)
...
class ETagRequestMixin(object):
    ...
    def cache_control(self):
        ...
        """
        cache_control = get('HTTP_CACHE_CONTROL')
    ...
    def if_match(self):
        ...
        """
        return parse_etags(get('HTTP_IF_MATCH'))
    ...
    def if_none_match(self):
        ...
        :rtype: :class:`~werkzeug.datastructures.ETags`
        """
        return parse_etags(get('HTTP_IF_NONE_MATCH'))

    @cached_property
    def if_modified_since(self):
        """The parsed `If-Modified-Since` header as datetime object."""
        return parse_date(get('HTTP_IF_MODIFIED_SINCE'))

    @cached_property
    def if_unmodified_since(self):
        """The parsed `If-Unmodified-Since` header as datetime object."""
        return parse_date(get('HTTP_IF_UNMODIFIED_SINCE'))
    ...
    def if_range(self):
        ...
        """
        return parse_if_range_header(get('HTTP_IF_RANGE'))
    ...
    def range(self):
        ...
        """
        return parse_range_header(get('HTTP_RANGE'))
...
class ETagResponseMixin(object):
    ...
    def cache_control(self):
        ...
        return parse_cache_control_header(get('cache-control'),
                                          on_update,
    ...
    def _is_range_request_processable(self, environ):
        ...
        return (
            ...
            or not is_resource_modified(
                environ, get('etag'), None,
                get('last-modified'), ignore_if_range=False
            )
    ...
    def _process_range_request(self, environ, complete_length=None, accept_ranges=None):
        ...
        if not self._is_range_request_processable(environ) or complete_length is None:
            return False
        parsed_range = parse_range_header(get('HTTP_RANGE'))
    ...
    def make_conditional(self, request_or_environ, accept_ranges=False,
        ...
        if environ['REQUEST_METHOD'] in ('GET', 'HEAD'):
            ...
            if not is206 and not is_resource_modified(
                ...
                if parse_etags(get('HTTP_IF_MATCH')):
    ...
    def _get_content_range(self):
        ...
        rv = parse_content_range_header(get('content-range'),
                                        on_update)
...
class CommonRequestDescriptorsMixin(object):
    ...
    def _parse_content_type(self):
        if not hasattr(self, '_parsed_content_type'):
            self._parsed_content_type = \
                parse_options_header(get('CONTENT_TYPE', ''))
    ...
    def pragma(self):
        ...
        """
        return parse_set_header(get('HTTP_PRAGMA', ''))
...
class CommonResponseDescriptorsMixin(object):
    ...
    def _get_mimetype_params(self):
        ...
        d = parse_options_header(get('content-type', ''))[1]

...
def is_resource_modified(environ, etag=None, data=None, last_modified=None,
    ...
    if not ignore_if_range and 'HTTP_RANGE' in environ:
        ...
        if_range = parse_if_range_header(get('HTTP_IF_RANGE'))

    if if_range is not None and if_range.date is not None:
        modified_since = if_range.date
    else:
        modified_since = parse_date(get('HTTP_IF_MODIFIED_SINCE'))
    ...
    if etag:
        ...
        if if_range is not None and if_range.etag is not None:
            ...
            if_none_match = parse_etags(get('HTTP_IF_NONE_MATCH'))
            if if_none_match:
            ...
            if_match = parse_etags(get('HTTP_IF_MATCH'))
            if if_match:
